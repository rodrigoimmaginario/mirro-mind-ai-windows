...
| [CV16](cv16-explorer-mode/index.md) | Explorer Mode | 🟢 DS0–DS3 Done |
...
surface, discard-current runtime hygiene, and explicit Explorer activation and
deactivation contract are done. The remaining arc adds in-session exploratory
field behavior, story thickening surfaces, promotion handoff, and later
